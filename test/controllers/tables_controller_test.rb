...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference('Table.count') do
      post tables_url, params: { table: { number: @table.number, restaurant_id: @table.restaurant_id, seats: @table.seats } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { number: @table.number, restaurant_id: @table.restaurant_id, seats: @table.seats } }
